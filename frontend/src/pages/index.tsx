  ...
  return (
    <div className="min-h-screen bg-slate-900 p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-white mb-8 text-center tracking-wide">Mini Task Challenge: Weather App Microservice</h1>
      </div>
      ...
      <div className="flex gap-8 justify-between">
        <div className="w-1/3 bg-slate-700/50 rounded-xl p-6 border border-slate-600">
          <h2 className="text-xl font-semibold mb-4 text-amber-400">Recent Locations</h2>
          <RecentLocations />
        </div>

        {currentWeather && (
          <div className="w-2/3 bg-slate-800 rounded-lg shadow-xl p-8 mb-8 border border-slate-700">
